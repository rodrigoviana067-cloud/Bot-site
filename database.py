...
if DATABASE_URL and 'postgres' in DATABASE_URL:
    ...
    def init_database():
        with get_db() as db:
            ...
            cur.execute("CREATE TABLE IF NOT EXISTS grupos (id SERIAL PRIMARY KEY, user_id INTEGER, grupo_id TEXT, grupo_nome TEXT, selecionado INTEGER DEFAULT 0, ativo INTEGER DEFAULT 1, nicho TEXT DEFAULT 'todos', created_at TEXT DEFAULT NOW())")
